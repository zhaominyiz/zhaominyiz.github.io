...
c.prototype=b.prototype;a.O=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.Uk=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
...
m.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.bl;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.wa}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);this.h.cookie=a+"="+b+(f?";domain="+f:"")+(g?";path="+g:"")+(0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(Date.now()+1E3*h)).toUTCString())+(d?";secure":"")+(null!=e?";samesite="+e:"")};
...
function Mf(a,b,c,d){d=void 0===d?{}:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=Kf(a,b,c,d);if(e)return e;e=++Jf.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var g=f?function(h){h=new Hf(h);if(!Lc(h.relatedTarget,function(k){return k==a}))return h.currentTarget=a,h.type=b,c.call(a,h)}:function(h){h=new Hf(h);
...
B(Rf,J);Rf.prototype.K=function(a){void 0===a.h&&If(a);var b=a.h;void 0===a.i&&If(a);this.i=new Dc(b,a.i)};
...
;var fg=/^[\w.]*$/,gg={q:!0,search_query:!0};function hg(a,b){b=a.split(b);for(var c={},d=0,e=b.length;d<e;d++){var f=b[d].split("=");if(1==f.length&&f[0]||2==f.length)try{var g=ig(f[0]||""),h=ig(f[1]||"");g in c?Array.isArray(c[g])?cb(c[g],h):c[g]=[c[g],h]:c[g]=h}catch(n){var k=n,l=f[0],p=String(hg);k.args=[{key:l,value:f[1],query:a,method:jg==p?"unchanged":p}];gg.hasOwnProperty(l)||zf(k)}}return c}
...
a=encodeURIComponent(String(Ae(a.toString())))}/^[\s\xa0]*$/.test(a)||(a=Ic("IFRAME",{src:'javascript:"<body><img src=\\""+'+a+'+"\\"></body>"',style:"display:none"}),(9==a.nodeType?a:a.ownerDocument||a.document).body.appendChild(a))}}else if(e)Cg(a,b,"POST",e,d);else if(E("USE_NET_AJAX_FOR_PING_TRANSPORT",!1)||d)Cg(a,b,"GET","",d);else{b:{try{var g=new Ta({url:a});if(g.j&&g.i||g.l){var h=ac(a.match($b)[5]||null),k;if(!(k=!h||!h.endsWith("/aclk"))){var l=a.search(fc);d:{for(c=0;0<=(c=a.indexOf("ri",
c))&&c<l;){var p=a.charCodeAt(c-1);if(38==p||63==p){var n=a.charCodeAt(c+2);if(!n||61==n||38==n||35==n){var t=c;break d}}c+=3}t=-1}if(0>t)var q=null;else{var D=a.indexOf("&",t);if(0>D||D>l)D=l;t+=3;q=decodeURIComponent(a.substr(t,D-t).replace(/\+/g," "))}k="1"!==q}f=!k;break b}}catch(K){}f=!1}f?Mg(a)?(b&&b(),f=!0):f=!1:f=!1;f||Ng(a,b)}}
...
function qh(a){var b={client:{hl:a.Za,gl:a.Ya,clientName:a.Xa,clientVersion:a.innertubeContextClientVersion,configInfo:a.Wa}},c=y.devicePixelRatio;c&&1!=c&&(b.client.screenDensityFloat=String(c));c=E("EXPERIMENTS_TOKEN","");""!==c&&(b.client.experimentsToken=c);c=[];var d=E("EXPERIMENTS_FORCED_FLAGS",{});for(e in d)c.push({key:e,value:String(d[e])});var e=E("EXPERIMENT_FLAGS",{});for(var f in e)f.startsWith("force_")&&void 0===d[f]&&c.push({key:f,value:String(e[f])});0<c.length&&(b.request={internalExperimentFlags:c});
f=b.client.clientName;if("WEB"===f||"MWEB"===f||1===f||2===f){if(!O("web_include_display_mode_killswitch")){var g;b.client.mainAppWebInfo=null!=(g=b.client.mainAppWebInfo)?g:{};b.client.mainAppWebInfo.webDisplayMode=xh()}}else if(g=b.client.clientName,("WEB_REMIX"===g||76===g)&&!O("music_web_display_mode_killswitch")){var h;b.client.Ja=null!=(h=b.client.Ja)?h:{};b.client.Ja.webDisplayMode=xh()}a.appInstallData&&(b.client.configInfo=b.client.configInfo||{},b.client.configInfo.appInstallData=a.appInstallData);
E("DELEGATED_SESSION_ID")&&!O("pageid_as_header_web")&&(b.user={onBehalfOfUser:E("DELEGATED_SESSION_ID")});a:{if(h=Gh()){a=Eh[h.type||"unknown"]||"CONN_UNKNOWN";h=Eh[h.effectiveType||"unknown"]||"CONN_UNKNOWN";"CONN_CELLULAR_UNKNOWN"===a&&"CONN_UNKNOWN"!==h&&(a=h);if("CONN_UNKNOWN"!==a)break a;if("CONN_UNKNOWN"!==h){a=h;break a}}a=void 0}a&&(b.client.connectionType=a);O("web_log_effective_connection_type")&&(a=Gh(),a=null!==a&&void 0!==a&&a.effectiveType?Fh.hasOwnProperty(a.effectiveType)?Fh[a.effectiveType]:
...
function Ih(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||E("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Tk||E("AUTHORIZATION"))||(a?b="Bearer "+A("gapi.auth.getToken")().Sk:b=gd([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=E("SESSION_INDEX",0),O("pageid_as_header_web")&&(d["X-Goog-PageId"]=E("DELEGATED_SESSION_ID")));return d}
...
bb(k.args))}catch(n){throw n.message="yt.pubsub2.Data.deserialize(): "+n.message,n;}}catch(n){throw n.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+b.toString()+": "+n.message,n;}a.call(window,f)}catch(n){yf(n)}},Vh[b.toString()]?A("yt.scheduler.instance")?Vf(g):Pf(g,0):g())});
...
v(Q,ki);function ui(a){Q.call(this,"MISSING_OBJECT_STORE",{Xk:a},pi.MISSING_OBJECT_STORE);Object.setPrototypeOf(this,ui.prototype)}
...
dbName:b});if("AbortError"===d.name)return new Q("UNKNOWN_ABORT",{objectStoreNames:c,dbName:b},d.message);d.args=[{name:"IdbError",Yk:d.name,dbName:b,objectStoreNames:c}];d.level="WARNING";return d}
...
Ti.prototype.count=function(a){return Fi(this.h.count(a))};
Ti.prototype.delete=function(a){return Vi(this,{query:a},function(b){return b.delete().then(function(){return b.continue()})})};
Ti.prototype.get=function(a){return Fi(this.h.get(a))};
Ti.prototype.getKey=function(a){return Fi(this.h.getKey(a))};
...
m.update=function(a){return Fi(this.cursor.update(a))};function Xi(a,b,c){return new Promise(function(d,e){function f(){t||(t=new Hi(g.result,{closed:n}));return t}
var g=self.indexedDB.open(a,b),h=c.blocked,k=c.blocking,l=c.ub,p=c.upgrade,n=c.closed,t;g.addEventListener("upgradeneeded",function(q){try{if(null===q.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");if(null===g.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");q.dataLoss&&"none"!==q.dataLoss&&ji("IDB_DATA_CORRUPTED",{reason:q.dataLossMessage||"unknown reason",dbName:ni(a)});var D=f(),K=new Ni(g.transaction);p&&p(D,q.oldVersion,q.newVersion,
...
function jj(a,b,c,d){var e;return G(this,function g(){var h,k;return x(g,function(l){switch(l.h){case 1:return w(l,kj({caller:"openDbImpl",publicName:a,version:b}),2);case 2:return mi(a),h=c?{actualName:a,publicName:a,userIdentifier:void 0}:ij(a),h.clearDataOnAuthChange=null!==(e=d.clearDataOnAuthChange)&&void 0!==e?e:!1,ra(l,3),w(l,bj(h),5);case 5:return w(l,Yi(h.actualName,b,d),6);case 6:return l.return(l.i);case 3:return k=sa(l),ra(l,7),w(l,cj(h.actualName),9);case 9:l.h=8;l.m=0;break;case 7:sa(l);
case 8:throw k;}})})}
...
;function rj(a,b){$i.call(this,a,b);this.options=b;mi(a)}
v(rj,$i);rj.prototype.i=function(a,b,c){c=void 0===c?{}:c;return(this.options.za?mj:lj)(a,b,Object.assign(Object.assign({},c),{clearDataOnAuthChange:this.options.clearDataOnAuthChange}))};
rj.prototype.delete=function(a){a=void 0===a?{}:a;return(this.options.za?qj:nj)(this.name,a)};
function sj(a,b){var c;return function(){c||(c=new rj(a,b));return c}}
;function tj(){R.call(this,function(){});
throw Error("Not allowed to instantiate the thennable outside of the core library.");}
v(tj,R);tj.reject=R.reject;tj.resolve=R.resolve;tj.all=R.all;var uj;function vj(){if(!uj){var a={};uj=sj("LogsDatabaseV2",{xa:(a.LogsRequestsStore=!0,a.sapisid=!0,a.SWHealthLog=!0,a),za:!O("nwl_use_ytidb_partitioning"),upgrade:function(b,c){2>c&&(Ki(b,"LogsRequestsStore",{keyPath:"id",autoIncrement:!0}).h.createIndex("newRequest",["status","authHash","interface","timestamp"],{unique:!1}),Ki(b,"sapisid"));3>c&&Ki(b,"SWHealthLog",{keyPath:"id",autoIncrement:!0}).h.createIndex("swHealthNewRequest",["interface","timestamp"],{unique:!1})},
version:3})}return uj().open()}
function wj(a){return G(this,function c(){var d,e,f,g,h;return x(c,function(k){switch(k.h){case 1:return d={startTime:P(),transactionType:"YT_IDB_TRANSACTION_TYPE_WRITE"},w(k,xj(),2);case 2:return e=k.i,w(k,vj(),3);case 3:return f=k.i,g=Object.assign(Object.assign({},a),{options:JSON.parse(JSON.stringify(a.options)),authHash:e,interface:E("INNERTUBE_CONTEXT_CLIENT_NAME",0)}),w(k,Mi(f,"LogsRequestsStore",g),4);case 4:return h=k.i,d.vb=P(),yj(d),k.return(h)}})})}
function zj(a){return G(this,function c(){var d,e,f,g,h,k,l,p;return x(c,function(n){switch(n.h){case 1:return d={startTime:P(),transactionType:"YT_IDB_TRANSACTION_TYPE_READ"},w(n,xj(),2);case 2:return e=n.i,f=E("INNERTUBE_CONTEXT_CLIENT_NAME",0),g=[a,e,f,0],h=[a,e,f,P()],k=IDBKeyRange.bound(g,h),w(n,vj(),3);case 3:return l=n.i,p=void 0,w(n,Ii(l,["LogsRequestsStore"],{mode:"readwrite",I:!0},function(t){return Vi(Ji(t,"LogsRequestsStore").index("newRequest"),{query:k,direction:"prev"},function(q){q.getValue()&&
(p=q.getValue(),"NEW"===a&&(p.status="QUEUED",q.update(p)))})}),4);
case 4:return d.vb=P(),yj(d),n.return(p)}})})}
function Aj(a){return G(this,function c(){var d;return x(c,function(e){if(1==e.h)return w(e,vj(),2);d=e.i;return e.return(Ii(d,["LogsRequestsStore"],{mode:"readwrite",I:!0},function(f){var g=Ji(f,"LogsRequestsStore");return g.get(a).then(function(h){if(h)return h.status="QUEUED",Fi(g.h.put(h,void 0)).then(function(){return h})})}))})})}
function Bj(a){return G(this,function c(){var d;return x(c,function(e){if(1==e.h)return w(e,vj(),2);d=e.i;return e.return(Ii(d,["LogsRequestsStore"],{mode:"readwrite",I:!0},function(f){var g=Ji(f,"LogsRequestsStore");return g.get(a).then(function(h){return h?(h.status="NEW",h.sendCount+=1,Fi(g.h.put(h,void 0)).then(function(){return h})):tj.resolve(void 0)})}))})})}
function Cj(a){return G(this,function c(){var d;return x(c,function(e){if(1==e.h)return w(e,vj(),2);d=e.i;return e.return(d.delete("LogsRequestsStore",a))})})}
function Dj(){return G(this,function b(){var c;return x(b,function(d){if(1==d.h)return w(d,vj(),2);c=d.i;return d.return(c.clear("LogsRequestsStore"))})})}
function Ej(){return G(this,function b(){var c,d;return x(b,function(e){if(1==e.h)return w(e,vj(),2);c=e.i;d=P()-2592E6;return w(e,Ii(c,["LogsRequestsStore"],{mode:"readwrite",I:!0},function(f){return Si(Ji(f,"LogsRequestsStore"),{},function(g){if(g.getValue().timestamp<=d)return g.delete().then(function(){return g.continue()})})}),0)})})}
function Fj(){return G(this,function b(){return x(b,function(c){return 1==c.h?w(c,pj(),2):w(c,qj("LogsDatabaseV2"),0)})})}
function xj(){return G(this,function b(){var c;return x(b,function(d){if(1==d.h){ci.h||(ci.h=new ci);var e={};var f=gd([]);f&&(e.Authorization=f,f=void 0,void 0===f&&(f=Number(E("SESSION_INDEX",0)),f=isNaN(f)?0:f),e["X-Goog-AuthUser"]=f,"INNERTUBE_HOST_OVERRIDE"in uf||(e["X-Origin"]=window.location.origin),O("pageid_as_header_web")&&"DELEGATED_SESSION_ID"in uf&&(e["X-Goog-PageId"]=E("DELEGATED_SESSION_ID")));e instanceof He||(f=new He(Ea),Ie(f,2,e),e=f);return w(d,e,2)}c=d.i;e=d.return;f=Jh(c);var g=
...
function Gj(a){return G(this,function c(){var d;return x(c,function(e){if(1==e.h)return w(e,vj(),2);d=e.i;return w(e,Mi(d,"sapisid",a,"sapisid"),0)})})}
function Hj(){return G(this,function b(){var c,d;return x(b,function(e){if(1==e.h)return w(e,vj(),2);if(3!=e.h)return c=e.i,w(e,c.get("sapisid","sapisid"),3);d=e.i;return e.return(d||"")})})}
function yj(a){var b=Df("nwl_latency_sampling_rate",.01);.02<b||Math.random()<=b&&Wh("nwl_transaction_latency_payload",a)}
;var Ij;function Jj(){if(!Ij){var a={};Ij=sj("ServiceWorkerLogsDatabase",{xa:(a.SWHealthLog=!0,a),za:!0,upgrade:function(b,c,d){1>c&&1<=d&&Ki(b,"SWHealthLog",{keyPath:"id",autoIncrement:!0}).h.createIndex("swHealthNewRequest",["interface","timestamp"],{unique:!1})},
version:1})}return Ij().open()}
function Kj(){return G(this,function b(){var c,d;return x(b,function(e){if(1==e.h)return O("web_clean_sw_logs_store")?w(e,Jj(),3):e.A(0);c=e.i;d=P()-2592E6;return w(e,Ii(c,["SWHealthLog"],{mode:"readwrite",I:!0},function(f){return Si(Ji(f,"SWHealthLog"),{},function(g){if(g.getValue().timestamp<=d)return g.delete().then(function(){return g.continue()})})}),0)})})}
function Lj(){return G(this,function b(){var c,d;return x(b,function(e){switch(e.h){case 1:return w(e,Jj(),2);case 2:return c=e.i,w(e,c.clear("SWHealthLog"),3);case 3:return w(e,vj(),4);case 4:return d=e.i,e.return(d.clear("SWHealthLog"))}})})}
;var Mj=["__Secure-1PAPISID","SAPISID","__Secure-3PAPISID"];function Nj(){for(var a=u(Mj),b=a.next();!b.done;b=a.next())if(b=cd.get(b.value))return b;return"LOGGED_OUT"}
function Oj(){xe.call(this);this.pollingInterval=3E3;this.i=[null,null,null];this.m=!1;Pj(this)}
v(Oj,xe);function Qj(){Oj.h||(Oj.h=new Oj);var a=Oj.h;a.m=!0;a.verifyUser();Rj(a)}
Oj.prototype.verifyUser=function(){var a=Pj(this),b=a.fb;if(!a.tb)return Rj(this),!0;ye(this,"ytsessionchange");b&&ye(this,"ytuserinvalid");Rj(this);return!1};
function Pj(a){var b=Mj.map(function(e){var f;return null!==(f=cd.get(e))&&void 0!==f?f:""}),c=b.some(function(e,f){return a.i&&""!==a.i[f]&&""===e}),d=b.some(function(e,f){return a.i&&a.i[f]!==e});
a.i=b;return{fb:c,tb:d}}
function Rj(a){a.m&&(Sj(a),a.l=Tf(function(){a.verifyUser()},a.pollingInterval))}
function Sj(a){a.l&&(Xf(a.l),a.l=void 0)}
;var Tj;function Uj(){Tj||(Tj=new Kh("yt.offline"));return Tj}
...
function Wj(){if(O("offline_error_handling")){var a=Uj().get("errors",!0);if(a){for(var b in a)if(a[b]){var c=new ki(b,"sent via offline_errors");c.name=a[b].name;c.stack=a[b].stack;c.level=a[b].level;yf(c)}Uj().set("errors",{},2592E3,!0)}}}
;var Xj=Df("network_polling_interval",3E4);function S(){xe.call(this);this.L=0;this.o=this.l=!1;this.B=0;this.m=this.J=!1;this.i=this.ka();this.m=O("validate_network_status");Yj(this);Zj(this)}
...
m.gb=function(a){this.l=!0;if(void 0===a?0:a)this.L||bk(this)};
...
function Zj(a){window.addEventListener("online",function(){return G(a,function c(){var d=this;return x(c,function(e){if(1==e.h)return d.m?w(e,d.T(),2):(d.i=!0,d.l&&ye(d,"ytnetworkstatus-online"),e.A(2));ck(d);d.J&&Wj();e.h=0})})})}
function Yj(a){window.addEventListener("offline",function(){return G(a,function c(){var d=this;return x(c,function(e){if(1==e.h)return d.m?w(e,d.T(),2):(d.i=!1,d.l&&ye(d,"ytnetworkstatus-offline"),e.A(2));ck(d);e.h=0})})})}
function bk(a){a.L=Tf(function(){return G(a,function c(){var d=this;return x(c,function(e){if(1==e.h){if(O("trigger_nsm_validation_checks_with_nwl")&&!d.i)return w(e,d.T(),3);if(d.ka()){if(!1!==d.i)return e.A(3);d.o=!0;d.B=P();return d.l?d.m?w(e,d.T(),11):(d.i=!0,ye(d,"ytnetworkstatus-online"),e.A(11)):e.A(11)}if(!0!==d.i)return e.A(3);d.o=!0;d.B=P();return d.l?d.m?w(e,d.T(),3):(d.i=!1,ye(d,"ytnetworkstatus-offline"),e.A(3)):e.A(3)}if(3!=e.h)return d.J&&Wj(),e.A(3);bk(d);e.h=0})})},Xj)}
function ck(a){a.o&&(zf(new ki("NetworkStatusManager state did not match poll",P()-a.B)),a.o=!1)}
...
S.prototype.sendNetworkCheckRequest=S.prototype.T;S.prototype.listen=S.prototype.ca;S.prototype.enableErrorFlushing=S.prototype.Ra;S.prototype.getWindowStatus=S.prototype.ka;S.prototype.monitorNetworkStatusChange=S.prototype.gb;S.prototype.isNetworkAvailable=S.prototype.N;S.getInstance=ak;function dk(a){a=void 0===a?{}:a;xe.call(this);var b=this;this.l=this.o=0;this.i=ak();var c=A("yt.networkStatusManager.instance.monitorNetworkStatusChange").bind(this.i);c&&c(a.Sa);a.eb&&(c=A("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.i))&&c();if(c=A("yt.networkStatusManager.instance.listen").bind(this.i))a.ma?(this.ma=a.ma,c("ytnetworkstatus-online",function(){ek(b,"publicytnetworkstatus-online")}),c("ytnetworkstatus-offline",function(){ek(b,"publicytnetworkstatus-offline")})):
...
function ek(a,b){a.ma?a.l?(Xf(a.o),a.o=Vf(function(){a.m!==b&&(ye(a,b),a.m=b,a.l=P())},a.ma-(P()-a.l))):(ye(a,b),a.m=b,a.l=P()):ye(a,b)}
...
function lk(){G(this,function b(){var c,d,e,f;return x(b,function(g){switch(g.h){case 1:return w(g,hj(),2);case 2:(c=g.i)&&(gk=!0);d=O("networkless_logging");if(c&&d)return O("nwl_use_ytidb_partitioning")?w(g,qj("LogsDatabaseV2"),8):w(g,pj(),8);if(!c){g.A(0);break}return w(g,Fj(),0);case 8:return Qj(),document.addEventListener("ytsessionchange",function(){mk()}),w(g,Hj(),11);
case 11:e=g.i;f=Nj();if(e===f){g.A(12);break}mk();return w(g,Gj(f),12);case 12:if(!(O("enable_nwl_cleaning_logic")&&Math.random()<=Df("nwl_cleaning_rate",.1))){g.A(14);break}return w(g,Ej(),15);case 15:return w(g,Kj(),14);case 14:fk=!0;nk();ok().N()&&pk();ok().ca("publicytnetworkstatus-online",pk);ok().ca("publicytnetworkstatus-offline",qk);if(!O("networkless_immediately_drop_sw_health_store")){g.A(17);break}return w(g,rk(),17);case 17:if(!O("networkless_immediately_drop_all_requests")){g.A(19);break}return w(g,
Fj(),19);case 19:O("export_networkless_options")&&(kk.isNwlInitialized=fk,kk.isIdbSupported=gk),g.h=0}})})}
function sk(a,b){function c(d){var e=ok().N();if(!tk()||!d||e&&O("vss_networkless_bypass_write"))uk(a,b);else{var f={url:a,options:b,timestamp:P(),status:"NEW",sendCount:0};wj(f).then(function(g){f.id=g;(ok().N()||O("networkless_always_online"))&&vk(f)}).catch(function(g){vk(f);
ok().N()?yf(g):Vj(g)})}}
b=void 0===b?{}:b;O("skip_is_supported_killswitch")?hj().then(function(d){c(d)}):c(wk())}
...
e.options.onSuccess=function(h,k){void 0!==e.id?Cj(e.id):f=!0;g(h,k)};
uk(e.url,e.options);wj(e).then(function(h){e.id=h;f&&Cj(e.id)}).catch(function(h){ok().N()?yf(h):Vj(h)})}else uk(a,b)}
b=void 0===b?{}:b;O("skip_is_supported_killswitch")?hj().then(function(d){c(d)}):c(wk())}
function pk(){var a=this;hk||(hk=Vf(function(){return G(a,function c(){var d;return x(c,function(e){if(1==e.h)return w(e,zj("NEW"),2);if(3!=e.h)return d=e.i,d?w(e,vk(d),3):(qk(),e.return());if(!O("nwl_throttling_race_fix")||hk)hk=0,pk();e.h=0})})},100))}
function qk(){Xf(hk);hk=0}
function vk(a){return G(this,function c(){var d;return x(c,function(e){switch(e.h){case 1:if(void 0===a.id){e.A(2);break}return w(e,Aj(a.id),3);case 3:(d=e.i)?a=d:zf(Error("The request cannot be found in the database."));case 2:if(yk(a,2592E6)){e.A(4);break}zf(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===a.id){e.A(5);break}return w(e,Cj(a.id),5);case 5:return e.return();case 4:var f=a=zk(a),g,h;if(null===(h=null===(g=null===f||void 0===f?void 0:f.options)||void 0===
...
a.options.onError=function(e,f){return G(b,function h(){return x(h,function(k){switch(k.h){case 1:if(!(O("trigger_nsm_validation_checks_with_nwl")&&(A("ytNetworklessLoggingInitializationOptions")?kk.potentialEsfErrorCounter:ik)<=Df("potential_esf_error_limit",10))){k.A(2);break}return w(k,ok().T(),3);case 3:if(ok().N())A("ytNetworklessLoggingInitializationOptions")&&kk.potentialEsfErrorCounter++,ik++;else return c(e,f),k.return();case 2:if(void 0===(null===a||void 0===a?void 0:a.id)){k.A(4);break}return 1>
a.sendCount?w(k,Bj(a.id),8):w(k,Cj(a.id),4);case 8:Vf(function(){ok().N()&&pk()},5E3);
case 4:c(e,f),k.h=0}})})};
var d=a.options.onSuccess?a.options.onSuccess:function(){};
a.options.onSuccess=function(e,f){return G(b,function h(){return x(h,function(k){if(1==k.h)return void 0===(null===a||void 0===a?void 0:a.id)?k.A(2):w(k,Cj(a.id),2);d(e,f);k.h=0})})};
return a}
function yk(a,b){a=a.timestamp;return P()-a>=b?!1:!0}
function nk(){var a=this;zj("QUEUED").then(function(b){b&&!yk(b,12E4)?Vf(function(){return G(a,function d(){return x(d,function(e){if(1==e.h)return void 0===b.id?e.A(2):w(e,Bj(b.id),2);nk();e.h=0})})}):O("nwl_trigger_throttle_after_reset")&&ok().N()&&pk()})}
function mk(){Dj().catch(function(a){yf(a)})}
function rk(){return G(this,function b(){return x(b,function(c){return c.return(Lj().catch(function(d){yf(d)}))})})}
function ok(){jk||(jk=new dk({eb:!0,Sa:O("trigger_nsm_validation_checks_with_nwl")}));return jk}
function uk(a,b){if(O("networkless_with_beacon")){var c=["method","postBody"];if(Object.keys(b).length>c.length)var d=!0;else{d=0;c=u(c);for(var e=c.next();!e.done;e=c.next())b.hasOwnProperty(e.value)&&d++;d=Object.keys(b).length!==d}d?zg(a,b):Og(a,void 0,b.postBody)}else zg(a,b)}
...
;function Ak(a){var b=this;this.config_=null;a?this.config_=a:Hh()&&(this.config_=rh());Tf(function(){Ph(b)},5E3)}
Ak.prototype.isReady=function(){!this.config_&&Hh()&&(this.config_=rh());return!!this.config_};
...
c.onFetchSuccess=function(N,X){Oh(q);K(N,X)}}try{t&&d.retry&&!d.Ka.bypassNetworkless?(g.method="POST",!d.Ka.writeThenSend&&O("nwl_send_fast_on_unload")?xk(n,g):sk(n,g)):(g.method="POST",g.postParams||(g.postParams={}),zg(n,g))}catch(N){if("InvalidAccessError"==N.name)q&&(Oh(q),q=0),zf(Error("An extension is blocking network request."));
...
groups:["key"]},{regexp:/\uac1c\uccb4\uac00 '([^']+)' \uc18d\uc131\uc774\ub098 \uba54\uc11c\ub4dc\ub97c \uc9c0\uc6d0\ud558\uc9c0 \uc54a\uc2b5\ub2c8\ub2e4./,groups:["key"]}]}}];var Ek={S:[],R:[{Ca:Dk,weight:500}]};function Dk(a){a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
...
a.fileName),d.push("Stacktrace: "+a.stack),window.console.log(d.join("\n"),a)),!(5<=Pk))){var g=Cd(a);d=g.message||"Unknown Error";e=g.name||"UnknownError";var h=g.stack||a.i||"Not available";h.startsWith(e+": "+d)&&(f=h.split("\n"),f.shift(),h=f.join("\n"));f=g.lineNumber||"Not available";g=g.fileName||"Not available";var k=0;if(a.hasOwnProperty("args")&&a.args&&a.args.length)for(var l=0;l<a.args.length&&!(k=Lk(a.args[l],"params."+l,c,k),500<=k);l++);else if(a.hasOwnProperty("params")&&a.params){var p=
a.params;if("object"===typeof a.params)for(l in p){if(p[l]){var n="params."+l,t=Nk(p[l]);c[n]=t;k+=n.length+t.length;if(500<k)break}}else c.params=Nk(p)}if(Sk.length)for(l=0;l<Sk.length&&!(k=Lk(Sk[l],"params.context."+l,c,k),500<=k);l++);navigator.vendor&&!c.hasOwnProperty("vendor")&&(c["device.vendor"]=navigator.vendor);l={message:d,name:e,lineNumber:f,fileName:g,stack:h,params:c,sampleWeight:1};c=Number(a.columnNumber);isNaN(c)||(l.lineNumber=l.lineNumber+":"+c);if("IGNORED"===a.level)a=0;else a:{a=
Hk();c=u(a.S);for(d=c.next();!d.done;d=c.next())if(d=d.value,l.message&&l.message.match(d.Wk)){a=d.weight;break a}a=u(a.R);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.Ca(l)){a=c.weight;break a}a=1}l.sampleWeight=a;a=u(Ck);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.ya[l.name])for(e=u(c.ya[l.name]),d=e.next();!d.done;d=e.next())if(f=d.value,d=l.message.match(f.regexp)){l.params["params.error.original"]=d[0];e=f.groups;f={};for(g=0;g<e.length;g++)f[e[g]]=d[g+1],l.params["params.error."+e[g]]=
...
(Rk++,Bk("appCrashed",{appCrashType:"APP_CRASH_TYPE_BREAKPAD"})),Qk++):"WARNING"===b&&Ik.W("handleWarning",l);if(O("kevlar_gel_error_routing")){a=b;b:{c=u(Tk);for(d=c.next();!d.done;d=c.next())if(Ig(d.value.toLowerCase())){c=!0;break b}c=!1}if(c)c=void 0;else{d={stackTrace:l.stack};l.fileName&&(d.filename=l.fileName);c=l.lineNumber&&l.lineNumber.split?l.lineNumber.split(":"):[];0!==c.length&&(1!==c.length||isNaN(Number(c[0]))?2!==c.length||isNaN(Number(c[0]))||isNaN(Number(c[1]))||(d.lineNumber=Number(c[0]),
...
f=E("SERVER_NAME",void 0);g=E("SERVER_VERSION",void 0);f&&g&&(e.kvPairs.push({key:"server.name",value:f}),e.kvPairs.push({key:"server.version",value:g}));c={errorMetadata:e,stackTrace:d,logMessage:c}}c&&(Bk("clientError",c),("ERROR"===a||O("errors_flush_gel_always_killswitch"))&&mh())}if(!O("suppress_error_204_logging")){a=l.params||{};b={urlParams:{a:"logerror",t:"jserror",type:l.name,msg:l.message.substr(0,250),line:l.lineNumber,level:b,"client.name":a.name},postParams:{url:E("PAGE_NAME",window.location.href),
...
;var Xk={hc:3611,wb:27686,xb:85013,yb:23462,Ab:42016,Bb:62407,Cb:26926,zb:43781,Db:51236,Eb:79148,Fb:50160,Gb:77504,Sb:87907,Tb:18630,Ub:54445,Vb:80935,Wb:105675,Xb:37521,Yb:47786,Zb:98349,ac:123695,cc:6827,dc:29434,ec:7282,fc:124448,kc:32276,jc:76278,lc:93911,mc:106531,nc:27259,oc:27262,pc:27263,sc:21759,tc:27107,uc:62936,wc:49568,xc:38408,yc:80637,zc:68727,Ac:68728,Bc:80353,Cc:80356,Dc:74610,Ec:45707,Fc:83962,Gc:83970,Hc:46713,Ic:89711,Jc:74612,Kc:93265,Lc:74611,Nc:113533,Oc:93252,Pc:99357,Rc:94521,
...
yi:30709,zi:30707,Ai:30711,Bi:30710,Ci:30708,xi:26984,Di:63648,Ei:63649,Fi:51879,Gi:111059,Hi:5754,Ii:20445,Ji:110386,Ki:113746,Li:66557,Mi:17310,Ni:28631,Oi:21589,Pi:68012,Qi:60480,Ri:31571,Si:76980,Ti:41577,Ui:45469,Vi:38669,Wi:13768,Xi:13777,Yi:62985,Zi:4724,aj:59369,bj:43927,cj:43928,dj:12924,ej:100355,hj:56219,ij:27669,jj:10337,gj:47896,kj:122629,lj:121258,mj:107598,nj:127568,oj:96639,pj:107536,qj:96661,rj:96658,sj:116646,tj:121122,uj:96660,vj:127083,wj:104443,xj:96659,yj:106442,zj:63667,Aj:63668,
Bj:63669,Cj:78314,Dj:55761,Ej:96368,Fj:67374,Gj:48992,Hj:49956,Ij:31961,Jj:26388,Kj:23811,Lj:5E4,Mj:126250,Nj:96370,Oj:47355,Pj:47356,Qj:37935,Rj:45521,Sj:21760,Tj:83769,Uj:49977,Vj:49974,Wj:93497,Xj:93498,Yj:34325,Zj:115803,ak:123707,bk:100081,ck:35309,dk:68314,ek:25602,fk:100339,gk:59018,hk:18248,ik:50625,jk:9729,kk:37168,lk:37169,mk:21667,nk:16749,pk:18635,qk:39305,rk:18046,sk:53969,tk:8213,uk:93926,vk:102852,wk:110099,xk:22678,yk:69076,Ak:100856,Bk:17736,Ck:3832,Dk:55759,Ek:64031,Fk:93044,Gk:93045,
Hk:34388,Ik:17657,Jk:17655,Kk:39579,Lk:39578,Mk:77448,Nk:8196,Ok:11357,Pk:69877,Qk:8197,Rk:82039};function Yk(){var a=kb(Zk),b;return Oe(new He(function(c,d){a.onSuccess=function(e){tg(e)?c(new $k(e)):d(new al("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
bl.prototype.then=function(a,b,c){return 1===this.i&&a?(a=a.call(c,this.h),Ge(a)?a:cl(a)):2===this.i&&b?(a=b.call(c,this.h),Ge(a)?a:dl(a)):this};
...
;function el(a){Sa.call(this,a.message||a.description||a.name);this.isMissing=a instanceof fl;this.isTimeout=a instanceof al&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof Pe}
v(el,Sa);el.prototype.name="BiscottiError";function fl(){Sa.call(this,"Biscotti ID is missing from server")}
v(fl,Sa);fl.prototype.name="BiscottiMissingError";var Zk={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},gl=null;function dg(){if(O("condition_biscotti_fetch_on_consent_cookie_html5_clients")&&!cd.get("CONSENT","").startsWith("YES+"))return Me(Error("User has not consented - not fetching biscotti id."));if("1"==ib())return Me(Error("Biscotti ID is not available in private embed mode"));gl||(gl=Oe(Yk().then(hl),function(a){return il(2,a)}));
return gl}
function hl(a){a=a.xhr.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new fl;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new fl;a=a.id;eg(a);gl=cl(a);jl(18E5,2);return a}
function il(a,b){b=new el(b);eg("");gl=dl(b);0<a&&jl(12E4,a-1);throw b;}
function jl(a,b){Pf(function(){Oe(Yk().then(hl,function(c){return il(b,c)}),Ea)},a)}
function kl(){try{var a=A("yt.ads.biscotti.getId_");return a?a():dg()}catch(b){return Me(b)}}
;function ll(a){if("1"!=ib()){a&&cg();try{kl().then(function(){},function(){}),Pf(ll,18E5)}catch(b){yf(b)}}}
...
return a.join("")}
;var ol,pl=y.ytLoggingDocDocumentNonce_;pl||(pl=nl(),Qa("ytLoggingDocDocumentNonce_",pl));ol=pl;var ql={je:0,ic:1,qc:2,ph:3,le:4,zk:5,ci:6,fj:7,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE"};function rl(a){this.h=a}
...
z("yt_logging_screen.getCttAuthInfo",Al,void 0);function Bl(a,b,c,d){c=void 0===c?0:c;if(a!==E(tl(c))||b!==E(ul(c)))zl(a,d,c),M(tl(c),a),M(ul(c),b),b=function(){setTimeout(function(){a&&wh("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:ol,clientScreenNonce:a},Ak)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b()}
z("yt_logging_screen.setCurrentScreen",Bl,void 0);function Cl(a){Qh.call(this,1,arguments);this.csn=a}
v(Cl,Qh);var Zh=new Rh("screen-created",Cl),Dl=[],Fl=El,Gl=0;function Hl(a,b,c,d){var e=d.filter(function(f){f.csn!==b?(f.csn=b,f=!0):f=!1;return f});
c={csn:b,parentVe:c.getAsJson(),childVes:Ya(e,function(f){return f.getAsJson()})};
d=u(d);for(e=d.next();!e.done;e=d.next())e=e.value.getAsJson(),(gb(e)||!e.trackingParams&&!e.veType)&&Uk(Error("Child VE logged with no data"));d={G:Al(b),U:b};"UNDEFINED_CSN"==b?Il("visualElementAttached",c,d):a?wh("visualElementAttached",c,a,d):Bk("visualElementAttached",c,d)}
function El(){for(var a=Math.random()+"",b=[],c=0,d=0;d<a.length;d++){var e=a.charCodeAt(d);255<e&&(b[c++]=e&255,e>>=8);b[c++]=e}return Bc(b)}
function Il(a,b,c){Dl.push({payloadName:a,payload:b,options:c});Gl||(Gl=$h())}
function ai(a){if(Dl){for(var b=u(Dl),c=b.next();!c.done;c=b.next())c=c.value,c.payload&&(c.payload.csn=a.csn,wh(c.payloadName,c.payload,null,c.options));Dl.length=0}Gl=0}
...
function em(a){var b=Yl(a||""),c=Xl(a);c&&!Vl&&(Wh(Rl,new Pl(Math.round(c-b._start),a)),Vl=!0)}
...
function lm(a,b){im[b]=im[b]||{count:0};var c=im[b];c.count++;c.time=P();a.h||(a.h=Tf(function(){var d=P(),e;for(e in im)im[e]&&6E4<d-im[e].time&&delete im[e];a&&(a.h=0)},5E3));
return 5<c.count?(6===c.count&&1>1E5*Math.random()&&(c=new ki("CSI data exceeded logging limit with key",b.split("_")),0<=b.indexOf("plev")||Uk(c)),!0):!1}
...
function Cm(){var a=document;if("visibilityState"in a)a=a.visibilityState;else{var b=Ff+"VisibilityState";a=b in a?a[b]:void 0}switch(a){case "hidden":return 0;case "visible":return 1;case "prerender":return 2;case "unloaded":return 3;default:return-1}}
function Bm(a){if(!sm(a)){var b=Yl(a),c=cm(a),d=b._start,e=E("CSI_SERVICE_NAME","youtube"),f={v:2,s:e,action:E((a||"")+"TIMING_ACTION",void 0)},g=c.srt;void 0!==b.srt&&delete c.srt;b.aft=Xl(a);var h=Yl(a),k=h.pbr,l=h.vc;h=h.pbs;k&&l&&h&&k<l&&l<h&&cm(a).yt_pvis&&"youtube"===e&&(xm("yt_lt","hot_bg",a),e=b.vc,k=b.pbs,delete b.aft,c.aft=Math.round(k-e));for(var p in c)"_"!==p.charAt(0)&&(f[p]=c[p]);b.ps=P();p={};e=[];for(var n in b)"_"!==n.charAt(0)&&(k=Math.round(b[n]-d),p[n]=k,e.push(n+"."+k));f.rt=
e.join(",");b=!!c.ap;c="";for(var t in f)f.hasOwnProperty(t)&&(c+="&"+t+"="+f[t]);f="/csi_204?"+c.substring(1);window.navigator&&window.navigator.sendBeacon&&(b||O("always_send_csi_204_with_beacon"))?Og(f):Lg(f);z("yt.timing."+(a||"")+"pingSent_",!0,void 0);Wh(Sl,new Ql(p.aft+(Number(g)||0),a))}}
...
function Km(a,b,c){c=void 0===c?{}:c;c.layer||(c.layer=0);var d=void 0!==c.ib?c.ib:c.layer;var e=yl(d);d=wl(d);var f;d&&(void 0!==c.parentCsn?f={clientScreenNonce:c.parentCsn,visualElement:d}:e&&"UNDEFINED_CSN"!==e&&(f={clientScreenNonce:e,visualElement:d}));var g,h=E("EVENT_ID");O("screen_manager_log_servlet_ei")&&"UNDEFINED_CSN"===e&&h&&(g={servletData:{serializedServletEventId:h}});try{var k=a.client;h=f;var l=c.Ea,p=c.G,n=Fl(),t={csn:n,pageVe:(new rl({veType:b,youtubeData:g})).getAsJson()};h&&
h.visualElement?t.implicitGesture={parentCsn:h.clientScreenNonce,gesturedVe:h.visualElement.getAsJson()}:h&&Uk(new ki("newScreen() parent element does not have a VE - rootVe",b));l&&(t.cloneCsn=l);l={G:p,U:n};k?wh("screenCreated",t,k,l):Bk("screenCreated",t,l);Wh(Zh,new Cl(n));var q=n}catch(D){Wk(D,{al:b,rootVe:d,parentVisualElement:void 0,Vk:e,Zk:f,Ea:c.Ea});Vk(D);return}Bl(q,b,c.layer,c.G);if((b=e&&"UNDEFINED_CSN"!==e&&d)&&!(b=O("screen_manager_skip_hide_killswitch"))){a:{b=u(Object.values(ql));
for(f=b.next();!f.done;f=b.next())if(yl(f.value)==e){b=!0;break a}b=!1}b=!b}b&&(b=a.client,f=!0,k=(f=void 0===f?!1:f)?16:8,d={csn:e,ve:d.getAsJson(),eventType:k},f={G:Al(e),U:e,Ta:f},"UNDEFINED_CSN"==e?Il("visualElementHidden",d,f):b?wh("visualElementHidden",d,b,f):Bk("visualElementHidden",d,f));a.h[a.h.length-1]&&!a.h[a.h.length-1].csn&&(a.h[a.h.length-1].csn=q||"");xm("csn",q);Jl.getInstance().clear();d=wl(c.layer);e&&"UNDEFINED_CSN"!==e&&d&&(O("web_mark_root_visible")||O("music_web_mark_root_visible"))&&
(e=q,q=O("use_default_events_client")?void 0:Ak,b={csn:e,ve:d.getAsJson(),eventType:1},f={G:Al(e),U:e},"UNDEFINED_CSN"==e?Il("visualElementShown",b,f):q?wh("visualElementShown",b,q,f):Bk("visualElementShown",b,f));a.i.delete(c.layer||0);a.j=void 0;e=u(a.m);for(q=e.next();!q.done;q=e.next())q=u(q.value),b=q.next().value,q.next().value.has(c.layer)&&d&&Im(a,b,d,c.layer)}
...
function Sm(a,b,c){c=void 0===c?null:c;var d=Tm(a),e=document.getElementById(d),f=e&&Nm(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=Tg(d,b),b=""+Ja(b),Um[b]=f),g||(e=Vm(a,d,function(){Nm(e,"loaded")||(Lm(e),Wg(d),Pf(Pa(Xg,d),0))},c)))}
function Vm(a,b,c,d){d=void 0===d?null:d;var e=Jc(document,"SCRIPT");e.id=b;e.onload=function(){c&&setTimeout(c,0)};
...
function Wm(a){a=Tm(a);var b=document.getElementById(a);b&&(Xg(a),b.parentNode.removeChild(b))}
function Xm(a,b){a&&b&&(a=""+Ja(b),(a=Um[a])&&Vg(a))}
...
try{Rm("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}Ym.push(Vf(function(){if(!(Zm||"google_ad_status"in window)){try{Xm("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}Zm=!0;M("DCLKSTAT",3)}},5E3))}}
...
function cn(a,b,c,d,e,f,g){g=void 0===g?!1:g;c?(a.i=!0,Rm(c,function(){a.i=!1;var h=0<=c.indexOf("/th/");(h?window.trayride:window.botguard)?dn(a,d,!!g,h,e):(Wm(c),Uk(new ki("Unable to load Botguard","from "+c)))},f)):b&&(f=Jc(document,"SCRIPT"),f.textContent=b,f.nonce=Wb(),document.head.appendChild(f),document.head.removeChild(f),((b=b.includes("trayride"))?window.trayride:window.botguard)?dn(a,d,!!g,b,e):Uk(Error("Unable to load Botguard from JS")))}
...
v(pn,J);pn.prototype.sendMessage=function(a,b){if(b=b||this.j){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var c=JSON.stringify(a);b.postMessage(c,this.C)}catch(d){zf(d)}}};
pn.prototype.D=function(){window.removeEventListener("message",this.B);J.prototype.D.call(this)};function qn(){this.i=[];this.isReady=!1;this.j={};var a=this.h=new pn(!!E("WIDGET_ID_ENFORCE")),b=this.kb.bind(this);a.m=b;a.o=null;this.h.channel="widget";if(a=E("WIDGET_ID"))this.h.sessionId=a}
m=qn.prototype;m.kb=function(a,b,c){"addEventListener"===a&&b?(a=b[0],this.j[a]||"onReady"===a||(this.addEventListener(a,rn(this,a)),this.j[a]=!0)):this.Aa(a,b,c)};
m.Aa=function(){};
...
;function wn(a){qn.call(this);this.listeners=[];this.api=a;this.addEventListener("onReady",this.onReady.bind(this));this.addEventListener("onVideoProgress",this.qb.bind(this));this.addEventListener("onVolumeChange",this.rb.bind(this));this.addEventListener("onApiChange",this.lb.bind(this));this.addEventListener("onPlaybackQualityChange",this.nb.bind(this));this.addEventListener("onPlaybackRateChange",this.ob.bind(this));this.addEventListener("onStateChange",this.pb.bind(this));this.addEventListener("onWebglSettingsChanged",
this.sb.bind(this))}
v(wn,qn);m=wn.prototype;
m.Aa=function(a,b,c){if(this.api.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&tn(a)){var d=b;if(Ia(d[0])&&!Array.isArray(d[0]))var e=d[0];else switch(e={},a){case "loadVideoById":case "cueVideoById":e=un(d[0],void 0!==d[1]?Number(d[1]):void 0,d[2]);break;case "loadVideoByUrl":case "cueVideoByUrl":e=d[0];"string"===typeof e&&(e={mediaContentUrl:e,startSeconds:void 0!==d[1]?Number(d[1]):void 0,suggestedQuality:d[2]});b:{if((d=e.mediaContentUrl)&&(d=/\/([ve]|embed)\/([^#?]+)/.exec(d))&&d[2]){d=
d[2];break b}d=null}e.videoId=d;e=un(e);break;case "loadPlaylist":case "cuePlaylist":e=vn(d[0],d[1],d[2],d[3])}b.length=1;b[0]=e}this.api.handleExternalCall(a,b,c);tn(a)&&sn(this,this.sa())}};
...
m.nb=function(a){sn(this,{playbackQuality:a})};
m.ob=function(a){sn(this,{playbackRate:a})};
...
m.rb=function(){sn(this,{muted:this.api.isMuted(),volume:this.api.getVolume()})};
...
m.sb=function(){var a={sphericalProperties:this.api.getSphericalProperties()};sn(this,a)};
...
m.D=function(){var a=this.connection;a.h||Ze(a.i,"command",this.La,this);this.connection=null;for(var b in this.i)this.i.hasOwnProperty(b)&&this.removeListener(b);J.prototype.D.call(this)};function An(a,b){xn.call(this,b);this.api=a;this.start()}
...
An.prototype.ra=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return xn.prototype.ra.call(this,a,b)};
...
Cn.prototype.D=function(){this.destination=this.j=null;Bn.prototype.D.call(this)};function Dn(a,b,c){J.call(this);this.destination=a;this.origin=c;this.i=Mf(window,"message",this.j.bind(this));this.connection=new Cn(this,a,b);Id(this,Pa(Gd,this.connection))}
v(Dn,J);Dn.prototype.Z=function(a,b,c,d){this.h||a!==this.destination||(a={id:b,command:c},d&&(a.data=d),this.destination.postMessage(Ae(a),this.origin))};
Dn.prototype.j=function(a){var b;if(b=!this.h)if(b=a.origin===this.origin)a:{b=this.destination;do{b:{var c=a.source;do{if(c===b){c=!0;break b}if(c===c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,"string"===typeof b)){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.connection,c.h||c.l("command",b.command,b.data,a.origin))}};
Dn.prototype.D=function(){Nf(this.i);this.destination=null;J.prototype.D.call(this)};function En(){J.call(this);this.i=[]}
v(En,J);En.prototype.D=function(){for(;this.i.length;){var a=this.i.pop();a.target.removeEventListener(a.name,a.Ca)}J.prototype.D.call(this)};function Fn(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||kb(b);this.assets=a.assets||{};this.attrs=a.attrs||kb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
...
function In(a){var b=Jn(a),c=document.getElementById(b),d=c&&Nm(c,"loaded");d||c&&!d||(c=Kn(a,b,function(){Nm(c,"loaded")||(Lm(c),Wg(b),Pf(Pa(Xg,b),0))}))}
...
function Jn(a){var b=Jc(document,"A");Tb(b,new Fb(a,Gb));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Zb(a)}
;function Ln(a,b,c,d){J.call(this);var e=this;this.F=b;this.webPlayerContextConfig=d;this.na=!1;this.api={};this.ba=this.m=null;this.J=new L;this.i={};this.L=this.fa=this.elementId=this.oa=this.config=null;this.K=!1;this.l=this.B=null;this.ga={};this.Na=["onReady"];this.lastError=null;this.Ba=NaN;this.C={};this.Oa=new En(this);this.P=0;this.j=this.o=a;Id(this,Pa(Gd,this.J));Mn(this);Nn(this);Id(this,Pa(Gd,this.Oa));c?this.P=Pf(function(){e.loadNewVideoConfig(c)},0):d&&(On(this),Pn(this))}
v(Ln,J);m=Ln.prototype;m.getId=function(){return this.F};
m.loadNewVideoConfig=function(a){if(!this.h){this.P&&(Qf(this.P),this.P=0);var b=a||{};b instanceof Fn||(b=new Fn(b));this.config=b;this.setConfig(a);Pn(this);this.isReady()&&Qn(this)}};
...
function Un(a){var b=Fc(a.elementId);!b&&a.j&&a.j.querySelector&&(b=a.j.querySelector("#"+a.elementId));return b}
function Wn(a){var b;if(!a.h){var c=Un(a),d=!1;c&&c.getApiInterface&&c.getApiInterface()&&(d=!0);d?(a.K=!1,!Yn(a,"html5_remove_not_servable_check_killswitch")&&(null===c||void 0===c?0:c.isNotServable)&&a.config&&(null===c||void 0===c?0:c.isNotServable(null===(b=a.config.args)||void 0===b?void 0:b.video_id))||ao(a)):a.Ba=Pf(function(){Wn(a)},50)}}
...
function Mn(a){a.na=!1;if(a.ba)for(var b in a.i)a.i.hasOwnProperty(b)&&a.ba(b,a.i[b]);for(var c in a.C)a.C.hasOwnProperty(c)&&Qf(Number(c));a.C={};a.m=null;a.ba=null;b=a.api;for(var d in b)b.hasOwnProperty(d)&&(b[d]=null);b.addEventListener=function(e,f){a.addEventListener(e,f)};
...
function Nn(a){a.addEventListener("WATCH_LATER_VIDEO_ADDED",function(b){Wg("WATCH_LATER_VIDEO_ADDED",b)});
...
m.addEventListener=function(a,b){var c=this,d=Sn(this,b);d&&(0<=Wa(this.Na,a)||this.i[a]||(b=co(this,a),this.m&&this.m(a,b)),this.J.subscribe(a,d),"onReady"===a&&this.isReady()&&Pf(function(){d(c.api)},0))};
m.removeEventListener=function(a,b){this.h||(b=Sn(this,b))&&Ze(this.J,a,b)};
...
function co(a,b){var c="ytPlayer"+b+a.F;a.i[b]=c;y[c]=function(d){var e=Pf(function(){if(!a.h){a.J.W(b,d);var f=a.C,g=String(e);g in f&&delete f[g]}},0);
hb(a.C,String(e))};
return c}
...
m.cancel=function(){this.B&&Xm(Vn(this),this.B);Qf(this.Ba);this.K=!1};
...
function Yn(a,b){var c;if(a.webPlayerContextConfig)var d=a.webPlayerContextConfig.serializedExperimentFlags;else if(null===(c=a.config)||void 0===c?0:c.args)d=a.config.args.fflags;return"true"===hg(d||"","&")[b]}
...
;var eo={},fo="player_uid_"+(1E9*Math.random()>>>0);function go(a,b,c){var d="player";c=void 0===c?!0:c;d="string"===typeof d?Fc(d):d;var e=fo+"_"+Ja(d),f=eo[e];if(f&&c)return ho(a,b)?f.api.loadVideoByPlayerVars(a.args||null):f.loadNewVideoConfig(a),f.api;f=new Ln(d,e,a,b);eo[e]=f;Wg("player-added",f.api);Id(f,function(){delete eo[f.getId()]});
return f.api}
...
;function no(a,b,c){a="ST-"+Zb(a).toString(36);b=b?dc(b):"";c=c||5;O("drop_st_cookie_before_cb")&&!mo()||yh(a,b,c)}
...
(b=Object.assign({csn:yl()},b)),k){var k=parseInt(k,10);isFinite(k)&&0<k&&no(d,b,k)}else no(d,b)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var p=void 0===p?"":p;var n=void 0===n?window:n;c=n.location;a=ec(a,l)+p;a=a instanceof Fb?a:Lb(a);c.href=Hb(a)}return!0}
;z("yt.setConfig",M,void 0);z("yt.config.set",M,void 0);z("yt.setMsg",Bf,void 0);z("yt.msgs.set",Bf,void 0);z("yt.logging.errors.log",Vk,void 0);
...
f=f.gelInfos?f.gelInfos:f.gelInfos={},sm())){for(var p in g)"tick_"+p in h||tm(p,g[p]);p=wm();g=dm();h={};for(var n in l)"info_"+n in f||!(k=vm(n,l[n]))||(Kl(p,k),Kl(h,k));km().info(h,g)}z("ytglobal.timingready_",!0,void 0);ym();(n=E("WEB_PLAYER_CONTEXT_CONFIGS",void 0))&&"WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER"in n?(n=n.WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER,n.serializedForcedExperimentIds||(p=mg(),p.forced_experiments&&(n.serializedForcedExperimentIds=p.forced_experiments)),io=go(a,
n,!1)):io=go(a);io.addEventListener("onVideoDataChange",lo);a=E("POST_MESSAGE_ID","player");E("ENABLE_JS_API")?ko=new wn(io):E("ENABLE_POST_API")&&"string"===typeof a&&"string"===typeof b&&(jo=new Dn(window.parent,a,b),ko=new An(io,jo.connection));$m();O("networkless_logging_web_embedded")&&lk();O("embeds_enable_ua_ch_polyfill")&&on()},void 0);
var po=xf(function(){Am();var a=Ah.getInstance(),b=!!((Dh("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&Ld(document.body,"exp-invert-logo"))if(c&&!Ld(document.body,"inverted-hdpi")){var d=document.body;if(d.classList)d.classList.add("inverted-hdpi");else if(!Ld(d,"inverted-hdpi")){var e=Jd(d);Kd(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi"))}}else!c&&Ld(document.body,"inverted-hdpi")&&Md();if(b!=c){b="f"+(Math.floor(119/31)+1);d=Dh(b)||0;d=c?d|67108864:
d&-67108865;0==d?delete zh[b]:(c=d.toString(16),zh[b]=c.toString());c=!0;O("web_secure_pref_cookie_killswitch")&&(c=!1);b=a.h;d=[];for(var f in zh)d.push(f+"="+encodeURIComponent(String(zh[f])));yh(b,d.join("&"),63072E3,a.i,c)}Gm.h||(Gm.h=new Gm);a=Gm.h;f=16623;var g=void 0===g?{}:g;Object.values(Xk).includes(f)||(Uk(new ki("createClientScreen() called with a non-page VE",f)),f=83769);g.isHistoryNavigation||a.h.push({rootVe:f,key:g.key||""});a.l=[];a.u=[];g.Fa?Jm(a,f,g):Km(a,f,g)}),qo=xf(function(){io&&
io.sendAbandonmentPing&&io.sendAbandonmentPing();
E("PL_ATT")&&fn.dispose();for(var a=0,b=Ym.length;a<b;a++)Xf(Ym[a]);Ym.length=0;Wm("//static.doubleclick.net/instream/ad_status.js");Zm=!1;M("DCLKSTAT",0);Hd(ko,jo);io&&(io.removeEventListener("onVideoDataChange",lo),io.destroy())});
...
Qa("yt.player.exports.navigate",A("yt.player.exports.navigate")||oo);Qa("yt.util.activity.init",A("yt.util.activity.init")||Zf);Qa("yt.util.activity.getTimeSinceActive",A("yt.util.activity.getTimeSinceActive")||bg);Qa("yt.util.activity.setTimestamp",A("yt.util.activity.setTimestamp")||$f);}).call(this);
